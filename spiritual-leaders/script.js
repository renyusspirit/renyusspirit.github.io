...
var crLook = document.getElementById('criteria-look');
var liLook = document.getElementById('list-look');

// 为按钮添加点击事件监听器
crLook.addEventListener('click', function() {
    // 在这里编写您希望在点击按钮时执行的代码
    window.location.href = './criteria';
});
liLook.addEventListener('click', function() {
    // 在这里编写您希望在点击按钮时执行的代码
